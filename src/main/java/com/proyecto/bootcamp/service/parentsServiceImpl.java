...
//	
	...
	@Override
	public Flux<Parents> findidnumber(String id) {
		// TODO Auto-generated method stub
		return repository.findidnumber(id);
	}

	@Override
	public Flux<Parents> findByComplementNameAndDescription(String complementname,String description) {
		// TODO Auto-generated method stub
	
		return repository.findByComplementNameAndDescription(complementname,description);
		
	}

	@Override
	public Flux<Parents> findByComplementNameAndDescriptionTeacher(String complementname, String description) {
		// TODO Auto-generated method stub
		return repository.findByComplementNameAndDescription(complementname, description);
	}
